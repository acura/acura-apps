...
<body>
	<%
		String merchant_id =CcavenueConstant.merchant_id; //Put your merchant id here
		String access_code = CcavenueConstant.access_code; //Put access code here
		String workingKey = CcavenueConstant.workingKey.trim(); //Put encryption key here
